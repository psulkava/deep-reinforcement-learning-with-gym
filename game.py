...
class Game:
    ...
    def __init__(self):
        game, model, render, episode_limit, batch_size, target_score = self._args()
        ...
        self.train_history = [('episode', 'score', 'average_score', 'steps', 'total_steps')]
        self.train()
            ...
            for episode in range(self.episode_limit):
                ...
                while True:
                    ...
                    if done:
                        ...
                        self.train_history.append((episode, score, average_score, step, total_steps))
    ...
    def _args(self):
        ...
        return game, model, render, episode_limit, batch_size, target_score
